...
const sortCountries = (countries, column, order) => {
    return countries.sort((a, b) => {
        let valueA, valueB;

        switch (column) {
            case "name":
                valueA = a._translations['fr'] || "";
                valueB = b._translations['fr'] || "";
                break;
            case "population":
                valueA = a._population || 0;
                valueB = b._population || 0;
                break;
            case "area":
                valueA = a._superficie || 0;
                valueB = b._superficie || 0;
                break;
            case "density":
                valueA = a.getPopDensity() || 0;
                valueB = b.getPopDensity() || 0;
                break;
            case "continent":
                valueA = a._continent || "";
                valueB = b._continent || "";
...
const displayCountries = () => {
    ...
    if (sortColumn) {
        filteredCountries = sortCountries(filteredCountries, sortColumn, sortOrder);
    }
